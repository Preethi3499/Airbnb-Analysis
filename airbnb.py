...
df1=pd.read_csv("C:/Users/Welcome/OneDrive/Desktop/Airbnb/Airbnb.csv")
print(df1)
...
if selected=='Home':
    ...
    with col1:
        st.image(Image.open("C:/Users/Welcome/OneDrive/Desktop/Airbnb/airbnb-logo.jpeg"), width=500)
    with col2:
